...
import bridge.converter.converters.TextConverter;
...
public class Client {
    public static void main(String[] args) {
        ...
        final var textConverter = new TextConverter();
        ...
        System.out.println(textConverter.getEmployeeFormated(developer));
        ...
        System.out.println(textConverter.getEmployeeFormated(projectManager));
    }
}
